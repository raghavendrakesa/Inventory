		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#cominventoryinventory-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"cominventoryinventory-display": {
								"semanticObject": "cominventoryinventory",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.inventory.inventory",
									"url": sap.ui.require.toUrl("com/inventory/inventory")
								}
							}
						}
					}
